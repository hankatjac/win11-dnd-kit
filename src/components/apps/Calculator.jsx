  ...
  return (
    <DndContext>
      <div className="z-30 w-full h-screen pointer-events-none absolute">
        <DraggableWindow id="calculator-window" bounds={bounds}>
          <div className="window bg-black w-[34em] h-[50em] rounded-xl overflow-hidden border-neutral-700 border-[1.5px] pointer-events-auto">
