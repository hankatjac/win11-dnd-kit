...
function Browser({ isAppOpen, toggleBrowser, bounds }) {
  ...
  return (
    <DndContext>
      <DraggableWindow id="browser-window" bounds={bounds}>
        <div className="window bg-black h-[45rem] w-[70.5rem] rounded-xl overflow-hidden border-neutral-700 border-[1.5px] pointer-events-auto">
